...
#### [Click here](./PROJECTS.md) for the complete list of beginner-friendly repositories. Give a shoutout my `DEV` [article](https://dev.to/vinitshahdeo/hacktoberfest-2020-is-here-17op). :heart: :hugs:
